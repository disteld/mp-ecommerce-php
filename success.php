...
var_dump($_POST);
    ...
    ?>
    <span>Operacion exitosa <br/><span>
	<p>Payment_id: <?php echo $_POST['collection_id'] ?></p>
	<p>external_reference: <?php echo $_POST['external_reference'] ?></p>
	<p>Preference_id: <?php echo $_POST['preference_id'] ?></p>
</body></html>
